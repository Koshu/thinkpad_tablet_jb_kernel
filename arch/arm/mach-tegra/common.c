...
/* Compal Earvin 20120419 begin */
static void indigo_pm_restart(char mode, const char *cmd) {
	SysRestart();
}
/* Compal Earvin 20120419 end */

void __init tegra_init_early(void)
{
	/* Compal Earvin 20120419 begin */
	arm_pm_restart = indigo_pm_restart;
	/* Compal Earvin 20120419 end */
#ifndef CONFIG_SMP
...
/* Compal Earvin 20111103 begin */
static int __init tegra_is_battery_fail_arg(char *options)
{
	char *p = options;

	isBatteryFail = memparse(p, &p);
	pr_info("Found isBatteryFail: %08lx\n", isBatteryFail);

	return 0;
}
early_param("isBatteryFail", tegra_is_battery_fail_arg);
/* Compal Earvin 20111103 end */
