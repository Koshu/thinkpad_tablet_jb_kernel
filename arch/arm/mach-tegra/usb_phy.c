...
static int ulpi_phy_power_on2(struct tegra_usb_phy *phy, bool is_dpd)
{
	int ret;
	unsigned long val;
	void __iomem *base = phy->regs;
...
static void ulpi_phy_power_off2(struct tegra_usb_phy *phy, bool is_dpd)
{
	unsigned long val;
	void __iomem *base = phy->regs;
...
static void ulpi_phy_restore_start2(struct tegra_usb_phy *phy)
{
	unsigned long val;
	void __iomem *base = phy->regs;
...
static void ulpi_phy_restore_end2(struct tegra_usb_phy *phy)
{
	unsigned long val;
	void __iomem *base = phy->regs;
	//struct tegra_ulpi_config *ulpi_config = phy->config;
