...
{
	/* Compal-Indigo-Jason Dong-20120309 begin : Instead of PM-MAX mode,                      */
        /*    we let WiFi module enters PM-FAST mode when system suspends.                        */
	/* For the issue "Indigo cannot enter sleep when connecting to some DIR615 access points" */
	//int power_mode = PM_MAX;
	int power_mode = PM_FAST;
	/* Compal-Indigo-Jason Dong-20120309 end. */
...
dhd_attach(osl_t *osh, struct dhd_bus *bus, uint bus_hdrlen)
{
	...
	// Compal-Indigo-Jason Dong-20111227 begin: assign the network interface name to bcm4329 driver
	strncpy(iface_name,"wlan",4);
	// Compal-Indigo-Jason Dong-20111227 end
