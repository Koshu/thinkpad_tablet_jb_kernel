...
{
	/* Compal-Indigo-Jason Dong-20111003 begin : Instead of PM-MAX mode, we let WiFi module enters PM-FAST mode when system suspends. */
	/* For the issue "Indigo cannot enter sleep when connecting to some DIR615 access points" */
	//int power_mode = PM_MAX;
	int power_mode = PM_FAST;
	/* Compal-Indigo-Jason Dong-20110808 end. */
